...
import { extLocales as boxExtensionsLocales } from '@ext/box.extensions/locales'
 ...
 *    但要唯一且稳定（本仓库两个扩展用 id 的驼峰：`ext.boxExtensions.*`、`ext.xeonskyZip.*`）；
...
const EXT_LOCALES: Record<string, ExtensionLocaleTable> = {
    'box.extensions': boxExtensionsLocales,
