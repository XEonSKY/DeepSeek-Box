        ...
        ext: {
            xeonskyZip: {
                ...
                panel: {
                    ...
                    download: '下载核心',
                    binPath: '可执行文件',
                    notConfigured: '未找到（可下载核心或手动指定路径）',
                    source: '状态与来源',
                    stAvailable: '可用',
                    stUnusable: '存在但不可用',
                    stMissing: '未找到',
                    srcCustom: '手动指定的路径',
                    srcAuto: '自动定位（核心目录或系统已装）',
                    srcMissing: '尚未就位',
                    target: '当前平台发行包',
                    targetUnsupported: '当前平台不在支持列表（仍可手动指定任意 7z 路径）',
                    coreDir: '核心目录',
                    pathPlaceholder: '7z / 7za / 7zz 可执行文件的完整路径（留空 = 自动定位）',
                    apply: '应用',
                    pathSaved: '已保存二进制路径。',
                    downloadOk: '核心已下载并解开。',
                    downloadPartial: '核心已下载，但自动解开失败：请手动解压到核心目录。',
                    downloadFail: '核心下载失败。',
                    formatsTitle: '支持的格式',
                    canCreate: '压缩',
                    canExtract: '解压',
    ...
    en: {
        ext: {
            xeonskyZip: {
                ...
                panel: {
                    coreTitle: '7-Zip core',
                    refresh: 'Refresh',
                    download: 'Download core',
                    binPath: 'Executable',
                    notConfigured: 'Not found (download a core or set a path manually)',
                    source: 'Status & source',
                    stAvailable: 'Available',
                    stUnusable: 'Present but unusable',
                    stMissing: 'Missing',
                    srcCustom: 'Manually specified path',
                    srcAuto: 'Auto-located (core directory or system install)',
                    srcMissing: 'Not in place yet',
                    target: 'Release package for this platform',
                    targetUnsupported: 'This platform is not in the list (you can still point to any 7z binary)',
                    coreDir: 'Core directory',
                    pathPlaceholder: 'Full path to the 7z / 7za / 7zz executable (empty = auto-locate)',
                    apply: 'Apply',
                    pathSaved: 'Binary path saved.',
                    downloadOk: 'Core downloaded and extracted.',
                    downloadPartial: 'Core downloaded, but auto-extract failed: extract it into the core directory manually.',
                    downloadFail: 'Core download failed.',
